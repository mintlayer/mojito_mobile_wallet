...
export interface InitOutput {
  ...
  readonly encode_lock_for_block_count: (a: number, b: bigint) => void;
  readonly encode_lock_for_seconds: (a: number, b: bigint) => void;
  readonly encode_lock_until_time: (a: number, b: bigint) => void;
  readonly encode_lock_until_height: (a: number, b: bigint) => void;
  ...
  readonly encode_output_issue_fungible_token: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: bigint, m: number) => void;
  readonly get_token_id: (a: number, b: number, c: number, d: number) => void;
  readonly encode_output_issue_nft: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: number, v: bigint, w: number) => void;
  ...
  readonly encode_input_for_withdraw_from_delegation: (a: number, b: number, c: number, d: number, e: bigint, f: number) => void;
  readonly estimate_transaction_size: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
  readonly encode_transaction: (a: number, b: number, c: number, d: number, e: number, f: bigint) => void;
  ...
  readonly encode_create_order_output: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => void;
  readonly encode_input_for_fill_order: (a: number, b: number, c: number, d: number, e: number, f: number, g: bigint, h: number) => void;
  readonly encode_input_for_conclude_order: (a: number, b: number, c: number, d: bigint, e: number) => void;

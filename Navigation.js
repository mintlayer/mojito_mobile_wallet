  ...
  return (
    <WalletsStack.Navigator screenOptions={{ headerHideShadow: true }}>
      <WalletsStack.Screen
        ...
        options={introduction.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="WalletsList"
      ...
      <WalletsStack.Screen
        name="HodlHodl"
        component={HodlHodl}
        options={HodlHodl.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="HodlHodlViewOffer"
        component={HodlHodlViewOffer}
        options={HodlHodlViewOffer.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="CPFP"
        component={CPFP}
        options={CPFP.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="RBFBumpFee"
        component={RBFBumpFee}
        options={RBFBumpFee.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="RBFCancel"
        component={RBFCancel}
        options={RBFCancel.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="Settings"
        component={Settings}
      ...
      <WalletsStack.Screen
        name="Currency"
        component={Currency}
        options={Currency.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="About"
        component={About}
      ...
      <WalletsStack.Screen
        ...
        options={ReleaseNotes.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="Selftest"
        component={Selftest}
        options={Selftest.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="Licensing"
        component={Licensing}
        options={Licensing.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="DefaultView"
      ...
      <WalletsStack.Screen
        name="Language"
        component={Language}
        options={Language.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="EncryptStorage"
        component={EncryptStorage}
        options={EncryptStorage.navigationOptions(theme)}
      />
      <WalletsStack.Screen
      ...
      <WalletsStack.Screen
        ...
        options={ElectrumSettings.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="TorSettings"
        component={TorSettings}
        options={TorSettings.navigationOptions(theme)}
      />
      <WalletsStack.Screen
      ...
      <WalletsStack.Screen
        name="Tools"
        component={Tools}
        options={Tools.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="LNDViewInvoice"
        component={LNDViewInvoice}
        options={LNDViewInvoice.navigationOptions(theme)}
      />
      <WalletsStack.Screen
      ...
      <WalletsStack.Screen
        name="Broadcast"
        component={Broadcast}
        options={Broadcast.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="IsItMyAddress"
        component={IsItMyAddress}
        options={IsItMyAddress.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="LnurlPay"
        component={LnurlPay}
        options={LnurlPay.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="LnurlPaySuccess"
        component={LnurlPaySuccess}
        options={LnurlPaySuccess.navigationOptions(theme)}
      />
      <WalletsStack.Screen
        name="Success"
        component={Success}
...
const AddWalletRoot = () => {
  ...
  return (
    <AddWalletStack.Navigator screenOptions={{ headerHideShadow: true }}>
      ...
      <AddWalletStack.Screen
        name="ImportSpeed"
        component={ImportSpeed}
        options={ImportSpeed.navigationOptions(theme)}
      />
      <AddWalletStack.Screen
        name="PleaseBackup"
        component={PleaseBackup}
        options={PleaseBackup.navigationOptions(theme)}
      />
      <AddWalletStack.Screen
      ...
      <AddWalletStack.Screen
        ...
        component={PleaseBackupLdk}
        options={PleaseBackupLdk.navigationOptions(theme)}
      />
      <AddWalletStack.Screen
        name="ProvideEntropy"
        component={ProvideEntropy}
        options={ProvideEntropy.navigationOptions(theme)}
      />
      <AddWalletStack.Screen
  ...
  return (
    <SendDetailsStack.Navigator screenOptions={{ headerHideShadow: true }}>
      ...
      <SendDetailsStack.Screen
        name="Confirm"
        component={Confirm}
        options={Confirm.navigationOptions(theme)}
      />
      <SendDetailsStack.Screen
      ...
      <SendDetailsStack.Screen
        ...
        options={SendCreate.navigationOptions(theme)}
      />
      <SendDetailsStack.Screen
        name="PsbtMultisig"
        component={PsbtMultisig}
        options={PsbtMultisig.navigationOptions(theme)}
      />
      <SendDetailsStack.Screen
      ...
      <SendDetailsStack.Screen
        ...
        options={CoinControl.navigationOptions(theme)}
      />
...
const AztecoRedeemRoot = () => {
  ...
  return (
    <AztecoRedeemStack.Navigator screenOptions={{ headerHideShadow: true }}>
      <AztecoRedeemStack.Screen
        name="AztecoRedeem"
        component={AztecoRedeem}
        options={AztecoRedeem.navigationOptions(theme)}
      />
...
const HodlHodlLoginRoot = () => {
  ...
  return (
    <HodlHodlLoginStack.Navigator
      name="HodlHodlLoginRoot"
      screenOptions={{ headerHideShadow: true }}
    >
      <HodlHodlLoginStack.Screen
        name="HodlHodlLogin"
        component={HodlHodlLogin}
        options={HodlHodlLogin.navigationOptions(theme)}
      />
    </HodlHodlLoginStack.Navigator>
  );
};
...
function DrawerRoot() {
  ...
  const isLargeScreen =
    Platform.OS === "android"
      ? isTablet()
      : (dimensions.width >= Dimensions.get("screen").width / 2 &&
          isTablet()) ||
        isDesktop;
  ...
  return (
    <Drawer.Navigator
      ...
      drawerContent={(props) =>
        isLargeScreen ? <DrawerList {...props} /> : null
      }
...
const LappBrowserStackRoot = () => {
  ...
  return (
    <LappBrowserStack.Navigator
      ...
      screenOptions={{ headerHideShadow: true }}
      initialRouteName="LappBrowser"
    >
      <LappBrowserStack.Screen
        name="LappBrowser"
  ...
  return (
    <AOPPStack.Navigator screenOptions={{ headerHideShadow: true }}>
      ...
      <AOPPStack.Screen
        name="AOPP"
        component={AOPP}
        options={AOPP.navigationOptions(theme)}
      />
      <AOPPStack.Screen
        name="SignVerify"
        component={SignVerify}
  ...
  return (
    ...
    >
      ...
      <RootStack.Screen
        ...
        options={{ headerShown: false, translucent: false }}
      />
      <RootStack.Screen
        name="AddWalletRoot"
      ...
      />
      <RootStack.Screen
        name="AztecoRedeemRoot"
        component={AztecoRedeemRoot}
        options={NavigationDefaultOptions}
      />
      <RootStack.Screen
        name="HodlHodlLoginRoot"
        component={HodlHodlLoginRoot}
        options={NavigationDefaultOptions}
      />
      <RootStack.Screen
        name="HodlHodlMyContracts"
        component={HodlHodlMyContracts}
        options={HodlHodlMyContracts.navigationOptions(theme)}
      />
      <RootStack.Screen
        name="HodlHodlWebview"
        component={HodlHodlWebview}
        options={HodlHodlWebview.navigationOptions(theme)}
      />
      ...
      <RootStack.Screen
        ...
        options={BuyBitcoin.navigationOptions(theme)}
      />
      <RootStack.Screen
        name="Marketplace"
        component={Marketplace}
        options={Marketplace.navigationOptions(theme)}
      />
      ...
      <RootStack.Screen
        name="LappBrowserRoot"
        component={LappBrowserStackRoot}
        options={NavigationDefaultOptions}
      />
      <RootStack.Screen
        name="AOPPRoot"

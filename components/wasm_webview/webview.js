 ...
 * @returns {string}
 */
function get_token_id(inputs, network) {
  let deferred3_0;
  let deferred3_1;
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {Uint8Array}
 */
function extract_htlc_secret(signed_tx_bytes, strict_byte_size, htlc_outpoint_source_id, htlc_output_index) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {Uint8Array}
 */
function encode_witness_htlc_secret(sighashtype, private_key_bytes, input_owner_destination, transaction_bytes, inputs, input_num, secret, network) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    const ptr0 = passArray8ToWasm0(private_key_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
function encode_multisig_challenge(public_keys_bytes, min_required_signatures, network) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {Uint8Array}
 */
function encode_witness_htlc_multisig(sighashtype, private_key_bytes, key_index, input_witness, multisig_challenge, transaction_bytes, utxos, input_num, network) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    const ptr0 = passArray8ToWasm0(private_key_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
function encode_create_order_output(ask_amount, ask_token_id, give_amount, give_token_id, conclude_address, network) {
  try {
    ...
    const len4 = WASM_VECTOR_LEN;
    wasm.encode_create_order_output(retptr, ptr0, ptr1, len1, ptr2, ptr3, len3, ptr4, len4, network);
    var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
    var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
    var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
 ...
 * @returns {Uint8Array}
 */
function encode_input_for_fill_order(order_id, fill_amount, destination, nonce, network) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    ...
    const len2 = WASM_VECTOR_LEN;
    wasm.encode_input_for_fill_order(retptr, ptr0, len0, ptr1, ptr2, len2, nonce, network);
    var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
    var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
    var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
 ...
 * @returns {Uint8Array}
 */
function encode_input_for_conclude_order(order_id, nonce, network) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    const ptr0 = passStringToWasm0(order_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.encode_input_for_conclude_order(retptr, ptr0, len0, nonce, network);
    var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
    var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
    var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);

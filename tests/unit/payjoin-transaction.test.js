...
describe('PayjoinTransaction', () => {
  it('throws if smth is wrong with pj transaction', async () => {
    ...
    const { tx: txOrig, psbt: psbtOrig } = w.createTransaction(utxos, [{ address: 'bc1qyvdzueznsh0rsyfqzdtj9ce7nlx4rlg2v93lcl', value: 10000 }], 6, w._getInternalAddressByIndex(0));
  ...
  it('works', async () => {
    ...
    // created cransaction:
    const psbtOrigin = bitcoin.Psbt.fromBase64('');
    const txOrigin = bitcoin.Transaction.fromHex('');
